...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isInclusivelyAfterDay = __webpack_require__(30);
	...
	var _TimeRangeController = __webpack_require__(40);
	  ...
	  _createClass(DayPickerRangeController, [{
	      ...
	      function onDayClick(day, e) {
	        ...
	        if (focusedInput === _constants.START_DATE) {
	          ...
	          if (!startDate) {
	            ...
	            endDate = (0, _moment2['default'])(day).endOf('day');
	    ...
	    value: function () {
	      function render() {
	        ...
	        var timeNotValid = _props8.timeNotValid;
	        var timeStep = _props8.timeStep;
