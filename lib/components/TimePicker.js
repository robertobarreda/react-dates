	    ...
	    _createClass(TimePicker, [{
	        ...
	        value: function () {
	            function render() {
	                ...
	                return _react2['default'].createElement('div', { className: "time-picker" + (disabled ? " disabled" : "") }, _react2['default'].createElement('span', { className: 'time-picker__label time-picker--align-middle' }, label), _react2['default'].createElement(_TimeInputSelector2['default'], {
	                    value: this.hours,
